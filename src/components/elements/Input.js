...
const Input = ({ type, name, placeholder, bgColor, font, color, border, borderColor, my, onChange, value, isRequired, ...props }) => {
  const [isRevealPwd, setIsRevealPwd] = useState(false);
  return (
    <div className={`${my?my:"my-2"} w-full relative`} {...props}>
